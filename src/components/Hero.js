...
export default function Hero() {
  return (
    <section className="relative flex flex-col md:flex-row justify-center lg:gap-[8rem] gap-[1rem] items-center px-8 pt-28 lg:pt-0 bg-gradient-to-r from-cyan-900/30 via-black to-cyan-900/30 min-h-[95vh]">
